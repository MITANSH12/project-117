...
document.getElementById("drawn_sketch").innerHTML = "Sketch to be Drawn: " + sketch;
timer_counter = 0;
timer_check = "";
drawn_sketch = "";
answer_holder = "";
...
if (timer_counter == 100 ||timer_counter == 200 ||timer_counter == 300 ||timer_counter == 400 ||timer_counter == 500 ||timer_counter == 600 ||timer_counter == 700 ||timer_counter == 800 ||timer_counter == 900 ||timer_counter == 1000 ) {
counter--;
if (counter == 0) {
counter = 10;
}
